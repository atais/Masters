...
public abstract class OutputDirectoryLogging {
	 ...
	 */
	synchronized public final static void initLogging(OutputDirectoryHierarchy outputDirectoryHierarchy) {
		if (collectLogMessagesAppender != null) {
	...
	synchronized private static void initLogging(String outputFilename, String warnLogfileName) throws IOException {
		Logger root = Logger.getRootLogger();

...
\begin{figure}[htbp]
	...
	\caption{Przykładowy wyjściowy układ drogowy w postaci grafu}
...
\begin{figure}[htbp]
	...
	\caption{Przykładowy uzupełniony układ drogowy w postaci grafu}
...
\begin{definition}
\textbf{Fenotyp} jest zestawem wartości, odpowiadających danemu genotypowi, czyli zdekodowaną strukturą, a~wiec jest zbiorem parametrów zadania (rozwiązaniem, punktem przestrzeni
poszukiwań).
\end{definition}
...
W niniejszym rozdziale opisane zostają technologie, które zostały użyte podczas tworzenia rozwiązania GRoNO.~Opisano użyte zewnętrzne biblioteki oraz wyjaśniono działanie kolejnych elementów systemu. Opisany został również sposób wdrożenia rozwiązania.
...
\section{Ustawienia projektu GRoNO wykorzystane podczas badań}

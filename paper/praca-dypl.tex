...
\captionof{table}{Najlepsze sieci otrzymane w wyniku działania algorytmu.}
\label{tab_best} 
...
\newpage
Poniżej prezentujemy grafy uzyskanych sieci, dla wizualizacji rozwiązań.\textbf{ W celu uproszczenia odnajdowania usuniętych węzłów, są one zaznaczone kolorem czerwonym.} Tak, jak w poprzednim przypadku, sieci zostały obrócone o~$90^{\circ}$ w~lewo. W niektórych przypadkach wycięte węzły są trudno widoczne, z powodu nikłej długości strzałki. Dotyczy to przede wszystkim przykładów: \ref{sioux5}, \ref{sioux7}, \ref{sioux9}, \ref{sioux10}, \ref{sioux11}, \ref{sioux12}, \ref{sioux13}, \ref{sioux14}, \ref{sioux16}. W tych sieciach zostały wycięte drogi w pobliżu węzła o numerze $ 15$.

\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/1/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/2/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/3/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/4/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/5/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/6/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/7/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/8/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/9/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/10/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/11/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/12/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/13/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/14/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/15/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/16/network2}
...
\begin{figure}[ht]
\centering
\includegraphics[totalheight=0.55\textheight, angle=90]{img/output/17/network2}

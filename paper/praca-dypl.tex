...
\begin{figure}[ht]
\centering
\includegraphics[width=0.75\textwidth, angle=90]{{{img/sioux/graph6.00-7.00}}}
\caption{Natężenie ruchu w mieście Sioux Falls w godzinach 6.00-7.00.} 
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.75\textwidth, angle=90]{{{img/sioux/graph7.00-8.00}}}
\caption{Natężenie ruchu w mieście Sioux Falls w godzinach 7.00-8.00.} 
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.75\textwidth, angle=90]{{{img/sioux/graph16.00-17.00}}}
\caption{Natężenie ruchu w mieście Sioux Falls w godzinach 16.00-17.00.} 
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.75\textwidth, angle=90]{{{img/sioux/graph17.00-18.00}}}
...
\captionof{lstlisting}{Plik konfiguracyjny projektu}
...
\caption{Logo systemu Linux Trisquel\cite{trisquel}}
\end{figure}
